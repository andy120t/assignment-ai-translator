...
class ArgumentParser:
    def __init__(self):
        self.parser = argparse.ArgumentParser(description='Translate English PDF book to Chinese or Japanese.')
        ...
        self.parser.add_argument('--language', type=str, default='Chinese', choices=['Chinese', 'Japanese'], help='The language you want to translate to. Choose between "Chinese" and "Japanese".')        
