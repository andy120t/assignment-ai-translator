...
class Model:
    def make_text_prompt(self, text: str, target_language: str) -> str:
        return f"Translate from English to {target_language}：{text}"

    def make_table_prompt(self, table: str, target_language: str) -> str:
        return f"Translate form English to {target_language} table，maintain spacing (spaces, separators) ，and return in tabular form:\n{table}"
